...
============================================================================
Script Purspose:
	This stored procedure performs ETL (Extract, Transform, Load) proccess to 
	populate Silver tables from Bronze tables.
...
begin
	declare log_messages text default '';
	set log_messages = concat(log_messages, '>> Truncating Table: silver.crm_cust_info\n');
	truncate table silver.crm_cust_info;
	-- inserting clean data from bronze to silver =====================================================================================
	set log_messages = concat(log_messages, '>> Inserting Data Into: silver.crm_cust_info\n');
	...
	set log_messages = concat(log_messages, '>> Truncating Table: silver.crm_prd_info\n');
	truncate table silver.crm_prd_info;
	-- inserting clean data to silver =======================================================================================
	set log_messages = concat(log_messages, '>> Inserting Data Into: silver.crm_prd_info\n');
	...
	set log_messages = concat(log_messages, '>> Truncating Table: silver.crm_sales_details\n');
	truncate table silver.crm_sales_details;
	-- inserting clean data into silver =====================================================================================
	set log_messages = concat(log_messages, '>> Inserting Data Into: silver.crm_sales_details\n');
	...
	set log_messages = concat(log_messages, '>> Truncating Table: silver.erp_cust_az12\n');
	truncate table silver.erp_cust_az12;
	-- inserting clean data into silver =============================================================
	set log_messages = concat(log_messages, '>> Inserting Data Into: silver.erp_cust_az12\n');
	...
	set log_messages = concat(log_messages, '>> Truncating Table: silver.erp_loc_a101\n');
	truncate table silver.erp_loc_a101;
	-- inserting clean data into silver ===================================================================================================
	set log_messages = concat(log_messages, '>> Inserting Data Into: silver.erp_loc_a101\n');
	...
	set log_messages = concat(log_messages, '>> Truncating Table: silver.erp_px_cat_g1v2\n');
	truncate table silver.erp_px_cat_g1v2;
	-- inserting cleand data into silver =================================================================================
	set log_messages = concat(log_messages, '>> Inserting Data Into: silver.erp_px_cat_g1v2\n');
	...
	-- inserted ==========================================================================================================
	select log_messages as ProcedureLog;
end $$
delimiter ;
